...
export const MOCK_ABOUT = {
  content: '成都市田家炳中学始建于1925年，时称"成城公学"，取意"众志成城，公学兴国"。后相继更名为成城中学、四川大学附属中学、成都十九中。2003年香港实业家、慈善家田家炳先生捐资助学，更名为"成都市田家炳中学"。2023年通过四川省一级示范性普通高中验收，2026年成为成都市六年贯通培养试点学校。学校现有高中部和初中部两个校区，共占地57亩，在校学生约3100人。',
};
...
export const MOCK_PHILOSOPHY = {
  content: '学校以"履仁崇智 明德卓行"为校训，以"崇实适性，润育心田"为办学理念，坚持"德育为先、五育并举"，构建"课程+活动+文化"三位一体育人体系。在长期办学实践中形成了"勤奋、严谨、求实、创新"的校风，"敬业、爱生、博学、善导"的教风，"勤学、善思、明理、笃行"的学风。',
};
